...
PARAM <- list()
PARAM$experimento  <- 3334
PARAM$semilla  <- 350003      #Establezco la semilla aleatoria, cambiar por SU primer semilla
#cp minsplit minbucket maxdept arbolitos semillas
#parameetros rpart
