...
param  <- list( "num.trees"=       1200,  #cantidad de arboles
                "mtry"=             60,  #cantidad de variables que evalua para hacer un split  sqrt(ncol(dtrain))
                "min.node.size"=  3000,  #tamaño minimo de las hojas
                "max.depth"=        20   # 0 significa profundidad infinita
              )

set.seed(350003) #Establezco la semilla aleatoria
