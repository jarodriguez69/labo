...
#Cambiar por la primer semilla de cada uno ! 350003, 350029, 350033, 350039, 350087
particionar( dataset, division=c(7,3), agrupa="clase_ternaria", seed= 350087 )  #Cambiar por la primer semilla de cada uno !
